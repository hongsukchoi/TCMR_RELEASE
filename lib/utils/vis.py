...
from lib.data_utils import _kp_utils
from lib.models.smpl import SMPL, SMPL_MODEL_DIR, get_smpl_faces
from lib.data_utils._img_utils import torch2numpy, torch_vid2numpy, normalize_2d_kp
...
def visualize_sequence(sequence, prefix='vis'):
    ...
    for i in range(seqlen):
        ...
        plt.savefig(f'./{prefix}_pose{i}.png')
        # plt.draw()
        # plt.pause(0.01)
        # plt.cla()
